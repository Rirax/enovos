...
//        -- -----------------------------------------------------
//        -- Table camagru.devices
//        -- -----------------------------------------------------
//        require $root . '/models/DevicesModel.php';
//        \model\DevicesModel::createTable($pdo, $DB_SCHEMA);

//        -- -----------------------------------------------------
//        -- Table camagru.data
//        -- -----------------------------------------------------
//        require $root . '/models/DataModel.php';
//        \model\DataModel::createTable($pdo, $DB_SCHEMA);
